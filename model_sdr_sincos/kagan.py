...
from angles2tensor import angles2tensor
...
def get_kagan_angle(strike1, dip1, rake1, strike2, dip2, rake2):
    ...
    tensor1 = angles2tensor(strike1, dip1, rake1)
    tensor2 = angles2tensor(strike2, dip2, rake2)
...
def conpa(pa_flag,pa_beg,pa_end,pa_np):
    pa_con=(pa_flag+1)*(pa_end-pa_beg)/pa_np+pa_beg;
    return pa_con
